---
title: "Datos policiales, Costa Rica 2021"
output: 
...
distritos <-
  st_read(dsn = "C:/PROYECTO/distritos_simplificados.geojson", quiet = TRUE) %>%
  st_transform(4326)
```

```{r datos-delitos, message=FALSE, warning=FALSE}
delitos <- read_xls(path="C:/PROYECTO/estadisticaspoliciales2021.xls")
...
Christopher Cadena Calvo (C11337) y Allan Marín Campos (C14428).
